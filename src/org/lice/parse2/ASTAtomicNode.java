...
import static org.lice.parse.Parse.*;
...
public class ASTAtomicNode extends ASTNode {
	...
	public Node accept(Sema sema) {
		switch (token.getType()) {
			case BinNumber: return new ValueNode(toBinInt(token.getStrValue()), getMetaData());
			case OctNumber: return new ValueNode(toOctInt(token.getStrValue()), getMetaData());
			case HexNumber: return new ValueNode(toHexInt(token.getStrValue()), getMetaData());
			...
			case BigInt: return new ValueNode(toBigInt(token.getStrValue()), getMetaData());
			case BigDec: return new ValueNode(toBigDec(token.getStrValue()), getMetaData());
