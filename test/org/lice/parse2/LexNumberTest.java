...
public class LexNumberTest {
	...
	public void testLexHexNumber() {
		...
		assertEquals(l.currentToken().getKind(), Token.TokenType.HexNumber);
	...
	public void testLexBinNumber() {
		...
		Lexer l = new Lexer(srcCode);
		assertEquals(l.currentToken().getKind(), Token.TokenType.BinNumber);
	...
	public void testLexDecNumber() {
		...
		Lexer l = new Lexer(srcCode);
		assertEquals(l.currentToken().getKind(), Token.TokenType.DecNumber);
	...
	public void testLexOctNumber() {
		...
		Lexer l = new Lexer(srcCode);
		assertEquals(l.currentToken().getKind(), Token.TokenType.OctNumber);
	...
	public void testLexFloatNumber() {
		...
		Lexer l = new Lexer(srcCode);
		assertEquals(l.currentToken().getKind(), Token.TokenType.FloatNumber);
	...
	public void testLexDoubleNumber() {
		...
		Lexer l = new Lexer(srcCode);
		assertEquals(l.currentToken().getKind(), Token.TokenType.DoubleNumber);
	...
	public void testLexLongInteger() {
		String srcCode = "123L";
		Lexer l = new Lexer(srcCode);
		assertEquals(l.currentToken().getKind(), Token.TokenType.LongInteger);
	...
	public void testLexBigInt() {
		String srcCode = "123N";
		Lexer l = new Lexer(srcCode);
		assertEquals(l.currentToken().getKind(), Token.TokenType.BigInt);
		assertEquals(l.currentToken().getStrValue(), "123");
		assertEquals(l.peekOneToken().getKind(), Token.TokenType.EOI);
	}
	...
	public void testLexBigDec1() {
		String srcCode = "123M";
		Lexer l = new Lexer(srcCode);
		assertEquals(l.currentToken().getKind(), Token.TokenType.BigDec);
		assertEquals(l.currentToken().getStrValue(), "123");
		assertEquals(l.peekOneToken().getKind(), Token.TokenType.EOI);
	}
